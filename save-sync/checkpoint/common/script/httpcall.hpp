...
namespace Http {
    ...
    struct Request {
        ...
        // Off by default to match every existing caller (scripts hitting
        // arbitrary/self-signed hosts). Callers that know their target's CA
        // chain (e.g. Drive/OAuth against Google) should set this and
        // caInfoPath rather than flipping the shared default.
